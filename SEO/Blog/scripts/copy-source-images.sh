...
# Usage: bash SEO/Blog/scripts/copy-source-images.sh
...
echo ""
echo "⚠️ 还需要新做："
echo "    03 hero        → bash SEO/Blog/scripts/render-html-to-png.sh 03-hero-supabase"
echo "    03 Task View   → 真实产品截图（见 SEO/Blog/scripts/README.md）"
echo "    04 cover       → bash SEO/Blog/scripts/render-html-to-png.sh 04-cover-roadshow"
