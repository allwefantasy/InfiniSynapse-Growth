...
本地视觉参考：**`PREVIEW-INDEX.html`** 或任意文章文件夹内的 **`preview.html`**（双击浏览器打开，**不要部署到线上**）
...
```
URL:     https://infinisynapse.cn/blog/{slug}
...
5. 内链格式已是 `/blog/other-slug` → 保持**站内相对路径**，**不要**加 `rel="nofollow"`
...
<head>
  ...
  <link rel="canonical" href="https://infinisynapse.cn/blog/{slug}">
  <!-- og:* / twitter:* / hreflang ... -->
