...
_spec = importlib.util.spec_from_file_location("hdr", BLOG / "high-dr-authority-sources.py")
_hdr = importlib.util.module_from_spec(_spec)
assert _spec and _spec.loader
_spec.loader.exec_module(_hdr)

_spec2 = importlib.util.spec_from_file_location("inline", BLOG / "audit-inline-external-links.py")
