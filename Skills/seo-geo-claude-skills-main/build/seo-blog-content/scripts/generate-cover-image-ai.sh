...
#   bash Skills/seo-geo-claude-skills-main/build/seo-blog-content/scripts/generate-cover-image-ai.sh 2026-05-19-data-agent-new-civilization
#
...
#   bash Skills/seo-geo-claude-skills-main/build/seo-blog-content/scripts/generate-cover-image-ai.sh 2026-05-19-foo --prompt "A cinematic ..."
#
# 常用 flags:
