...
bash Skills/seo-geo-claude-skills-main/build/seo-blog-content/scripts/copy-source-images.sh
...
cp Skills/seo-geo-claude-skills-main/build/seo-blog-content/scripts/cover-prompt.template SEO/Blog/<slug>/prompts/cover.prompt
# ↑ 用编辑器改成本篇博客适用的描述

# 2) 出图（默认 imagen-4 / 16:9 / 2k，约 $0.038/张，输出到 images/cover-ai.png）
bash Skills/seo-geo-claude-skills-main/build/seo-blog-content/scripts/generate-cover-image-ai.sh <slug>

# 3) 跑全部已写 prompt 的博客
bash Skills/seo-geo-claude-skills-main/build/seo-blog-content/scripts/generate-cover-image-ai.sh all

# 4) 看计划但不真跑（不花钱）
bash Skills/seo-geo-claude-skills-main/build/seo-blog-content/scripts/generate-cover-image-ai.sh all --dry-run
```
