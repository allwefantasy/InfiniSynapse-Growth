...
| Hero cover | First image = article H1 on 1200×630 dark tech cover; `og-cover.png` synced; matches `og:image` and schema `image` — see [blog-hero-cover-spec.md](blog-hero-cover-spec.md). |
...
- [ ] Blog bundle: `preview.html` generated and spot-checked ([blog-preview-html-spec.md](blog-preview-html-spec.md)).
