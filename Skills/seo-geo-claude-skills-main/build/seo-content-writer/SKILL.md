...
When a user requests SEO content, run these steps:
...
7. **Apply On-Page Best Practices** — manage keyword placement, readability, snippets, supporting visuals, and the **blog hero cover** (H1 title on image, 1200×630, dark tech style — see [Blog Hero Cover Spec](references/blog-hero-cover-spec.md)).
...
10. **Generate Preview HTML** (blog bundles) — emit `preview.html` per article and `INDEX-preview.html` at pillar root for local review; see [Blog Preview HTML Spec](references/blog-preview-html-spec.md). Do not deploy preview files to production.
...
- [Blog Hero Cover Spec](https://github.com/aaron-he-zhu/seo-geo-claude-skills/blob/main/build/seo-content-writer/references/blog-hero-cover-spec.md) — Hero/OG image: title, 16:9, dark tech geometry, HTML render rules
- [Blog Preview HTML Spec](https://github.com/aaron-he-zhu/seo-geo-claude-skills/blob/main/build/seo-content-writer/references/blog-preview-html-spec.md) — `preview.html` + index for local editorial/frontend review (not deployed)
