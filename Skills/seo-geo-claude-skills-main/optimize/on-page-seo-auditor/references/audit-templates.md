...
**Blog hero (first image)**: Verify against [Blog Hero Cover Spec](../../build/seo-content-writer/references/blog-hero-cover-spec.md) — H1 text on image, 1200×630, matches `og:image` / schema `image`, no placeholder typography.
